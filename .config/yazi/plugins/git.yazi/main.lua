...
local function setup(st, opts)
	...
	local styles = {
		...
		[CODES.ignored] = t.ignored or ui.Style():fg("#6c7086"),
		[CODES.untracked] = t.untracked or ui.Style():fg("#cba6f7"),
		[CODES.modified] = t.modified or ui.Style():fg("#f9e2af"),
		[CODES.added] = t.added or ui.Style():fg("#a6e3a1"),
		[CODES.deleted] = t.deleted or ui.Style():fg("#f38ba8"),
		[CODES.updated] = t.updated or ui.Style():fg("#fab387"),
